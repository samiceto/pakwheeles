...
const Feature = () => {
  return (
    <div className='bg-gray-100 p-14 h-fit relative'>
        <div className='flex justify-between'>
            <p className='opacity-50 bg-white rounded-[300%] p-2 px-4 hidden md:block absolute right-[92%] top-64 shadow-sm shadow-slate-400'>❰</p>
            <p className='opacity-50 bg-white rounded-[300%] p-2 px-4 hidden md:block absolute left-[92%] top-64 shadow-sm shadow-slate-400'>❱</p>
        </div>
        <div className='flex justify-between'>
        ...
        <div className='flex gap-4 w-fit mx-auto md:flex-row flex-col'>
            <div className='px-2 py-4 bg-white md:w-56 w-[80vw] shadow-lg shadow-slate-300'>
