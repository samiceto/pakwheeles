...
const page = () => {
  return (
    <div className='bg-blue-100 text-center flex flex-col gap-7 pt-10 h-full px-10'>
        <p className='text-center font-bold underline text-2xl'>Toyota Corolla 2024 Price in Pakistan, Images, Reviews & Specs</p>
        <Image src="/15.jpg" alt="/" width={500} height={500} className='mx-auto h-52 w-auto'></Image>
        <div className='flex w-fit md:flex-row flex-col mx-auto gap-1'>
        ...
        <div className='flex w-fit md:flex-row flex-col mx-auto'>
        ...
        <button className='text-white bg-blue-600 py-3 px-7 mb-2 rounded-md mx-auto'><Link href="/form">Make Payment</Link></button>
    </div>
  )
}
