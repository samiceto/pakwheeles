...
const page = () => {
  return (
    <div className='bg-blue-100 text-center flex flex-col gap-7 pt-10 h-full'>
        ...
        <Image src="/35.jpg" alt="/" width={500} height={500} className='mx-auto h-52 w-auto'></Image>
        ...
        <button className='text-white bg-blue-600 mb-2 py-3 px-7 rounded-md mx-auto'><Link href="/form">Make Payment</Link></button>
    </div>
  )
}
